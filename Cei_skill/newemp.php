		   ...
		   <div class="home-content-tablecell">
		   	<div class="row">
		   		<div class="col-twelve">		   			
			  				...
			  				<h1 class="animate-intro">New Employee</h1>
							<br/><br/><br/>
				  			<h3 class="animate-intro"><center>
							<form name="emp" action="emp.php" method="post">
								<div style="margin-bottom:30px;"><input type="text" name="eid" placeholder="Employee ID">
																<input type="email" name="emid" placeholder="Email ID">								
								</div>
