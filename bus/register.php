...
.form{font-weight: bold; padding-left: 5px; color: #3B5998; width: 50%; height: 40px; font-size: 18px; background-color: transparent; border-radius: 10px; border: 2px solid; border-color: #000000;}
