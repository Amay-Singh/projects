...
<html lang="en-US">
  ...
  <head>
	...
	<title>Bus Ticket Reservation Registration</title>
	<style>
		.background-image{
		opacity: 0.9;
  ...
  <body class="size-1280">
    ...
    <main role="main">    
      ...
      <header class="section-top-padding background-image text-center" style="background-image:url(register.jpg);">
        <h1 class="text-s-size-40 text-m-size-50 text-size-50 text-line-height-1 margin-bottom-1 margin-top-1" style="font-weight: 500; text-outline: 1px black; color: white;">
          <span style="color: black">WELCOME <br><br>Register your company's bus below</span>
        </h1><br>
		<div>
			<br><br><br><br>
		</div>
            ...
            <div class="row" style="margin: 5% 0 5% 0; color: #28a5df">
				...
				?>
					<form method="post" action='added.php'>
						<input name="name" type="text" id="name" required class="form"  placeholder="Travels Name"><br><br>
