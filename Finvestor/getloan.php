<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    $error="".$amount." ".$date." ".$itype;

    if(!is_numeric($amount)) $amount="";

    if($itype == "" || $amount =="" || $date =="") $error="Enter All Fields Correctly!";
    else{

      $sql_req = "INSERT INTO loan_request (c_id,amount,required_by,interest_type) VALUES ('$cid','$amount','$date','$itype')";
    #  echo $sql_req;
      $results = mysqli_query($db, $sql_req);
      $error="";
    }
  }
?>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Get Loan</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
        </div> -->
        <div class="main-content-inner container pb-4 pt-4">
                <div class="row">
                    <div class="col-12">
                        <div class="card pad-25">
                            <div class="card-body row"> 
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <h4 class="header-title">Apply for loan</h4>
                                        <form action="getloan.php" method="post" >
                                                ...
                                                <div class="form-group">
                                                    <label for="example-date-input" class="col-form-label">Required By</label>
                                                    <input class="form-control" type="date" value="0000-00-00" name="rb" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="Select">Interest Payable</label>
                                                    <select name="ityp" class="form-control" >
                                                        <option>Daily</option>
