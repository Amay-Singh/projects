        ...
        if($_SESSION['log']==true){
          ...
          elseif($_SESSION['user_type'] == "f"){
            ...
            <li class='navbx text-uppercase'><a href='finTable.php'>Financier Table</a></li>
                       ...
                       <li class='active navbx text-uppercase'><a href='acceptedloans.php'>Accepted Loans</a></li>";
          }
         }
        ?>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-4">
                        <div class="card pad-25">
                            <div class="card-body">
                                <h4 class="header-title">Accepted Loans Table</h4>
                                ...
                                <div class="data-tables">
                                    <table id="dataTable" class="text-center" style="width:100%;">
                                        ...
                                        $sql_loanr = "SELECT * FROM loan_request WHERE accepted='1'";
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a href="loan_reject.php?cid=<?php echo $cid;?>&amount=<?php echo  $loanrequests['amount'];?>&rb=<?php echo  $loanrequests['required_by'];?>"><?php echo $customers['customer_name']; ?></a></td>
