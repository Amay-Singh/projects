<?php
  ...
  if(!isset($_GET['cid'])){
    header("Location: loanapplicants.php");
  }
  ...
  $customer= mysqli_fetch_assoc($res_cus);
   ...
   if (isset($_POST['accept'])){
     ...
     $sql_acc = "UPDATE loan_request SET accepted = '1' WHERE c_id='$cid'";
     $res_acc = mysqli_query($db, $sql_acc) or die( mysqli_error($db));
     header("Location: loanapplicants.php");
   }
                        ...
                        <div class="horizontal-menu">
                            <nav>
                                <ul id="nav_menu">
                                    ...
                                    <li>
                                        <a href="loanapplicants.php"><i class="fa fa-toggle-off"></i><span>Applicants</span></a>
                                    </li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><a href="loanapplicants.php"><span>Applicants</span></a></li>
                            ...
                            <div class="card-body">
                                <div class="customer-area">
                                    ...
                                    <form  action="#" method="post">
                                      <div align="center">
                                        <button type="submit" name="accept" id="accept" class="btn btn-lg btn-primary">accept</button>
                                      </div>
                                    </form>
                            </div>
                        </div>
