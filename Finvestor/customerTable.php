<?php
  ...
  $sql_loanc = "SELECT * FROM loan_contract WHERE c_id='$cid'";
  $res_loanc = mysqli_query($db, $sql_loanc) or die( mysqli_error($db));
  $loancontract = mysqli_fetch_assoc($res_cus);
...
<body class="body-bg">
    ...
    <div class="horizontal-main-wrapper">
          ...
          if($_SESSION['user_type'] == "c"){
            $list .=  "<li class='navbx text-uppercase'><a href='index.php'>Home</a></li>
                        <li class='navbx text-uppercase'><a href='getloan.php'>Get Loan</a></li>
                           <li class='active navbx text-uppercase'><a href='customerTable.php'>Customer Table</a></li>";
          }
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><a href="#"><span>Customer Table</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="main-content-inner pb-4 pt-4">
                <div class="row">
                    <!-- data table start -->
                    <div class="col-12">
                        <div class="card pad-25">
                            <div class="card-body">
                                <h4 class="header-title">Customer Table</h4>
                                <p class="header-tag">Click name to get complete Financier details</p>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                              while($loancontract = mysqli_fetch_assoc($res_loanc)){
                                                ...
                                                while ($financer= mysqli_fetch_assoc($res_fin)) {
                                            ?>
                                            <tr>
                                                <td><a href="financerinfo.php?fid=<?php echo $fid?>&lid=<?php echo $lid; ?>"><?php echo $financer['financier_name']; ?></a></td>
                                                <td>+91-<?php echo $financer['phone_number']; ?></td>
