...
<html lang="en-US">
  ...
  <head>
   ...
   <link rel="icon" href="images/logo.jpg" type="image/x-icon" />
	<title>CEI Employees | New Skill</title>
    ...
    <main role="main">    
      ...
      <header class="section-top-padding background-image text-center" style="background-image:url(add.jpg);">
        <h1 class="text-extra-thin text-s-size-30 text-m-size-40 text-size-50 text-line-height-1 margin-bottom-100 margin-top-250" style="font-weight: bold;">
          Add <span style="color: white">new </span><span style="color: red">skill</span><!--<span style="color: #21a2de"> details!</span>-->
        </h1><br><br><br>
          ...
          <div class="margin2x">
            <div class="row" style="margin: 5% 0 5% 0; color: #28a5df">
				...
				<?php
					...
					{
				?>
						<br><span style="color:green">Skill has been successfully added to the database</span><br>
				<?php
						$_SESSION['error']=0;
					}
					...
					{
				?>	
						<br><span style="color:red">Skill could not be added to the database</span><br>
				<?php
						$_SESSION['error']=0;
					}
				?>
					<form method="post" action="newskill.php">
						<div id="skill-name">
							<br>
							<input type="text" required name="skillname" placeholder="Skill Name" class="formboxes" style="padding-left: 2px; text-transform: uppercase;">
						</div>
						<div id="formbuttons">
							<br><br>
							<input class="ContentButtons" type="submit" value="ADD SKILL"/>
