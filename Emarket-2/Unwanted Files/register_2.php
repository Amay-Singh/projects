            ...
            <div class="row" style="margin: 5% 0 5% 0; color: #28a5df">
				...
				?>
					<form method="post" action='regis.php'>
						...
						<input name="reg" type="text" id="reg" required class="form"  placeholder="Registration No."><br><br>
						...
						<textarea name="address" rows="2" placeholder="Address" class="form" noresize></textarea><br><br>
						<select class="form" onchange="set_country(this,country,city_state)" size="1" name="region">
						...
						<select name="country" class="form" size="1" disabled="disabled" onchange="set_city_state(this,city_state)"></select><br><br>
						
						<select name="city_state" class="form" size="1" disabled="disabled" onchange="print_city_state(country,this)"></select><br><br>
						<input name="pwd" type="password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form" id="pwd" placeholder="Password"><br><br>
						<input name="conf-pwd" type="password" required pattern="(?=.*\d)(?=.*[a-z]).{8,}" class="form" id="conf-pwd" onblur="check()" placeholder="Re-enter Password"><br>
						<br><p id="errormsg" style="display:none;"></p><br><br>
						<p style="font-size: 110%; color: #3B5998"><strong><span style="color: red">NOTE: </span></strong> Password is case sensitive and it must contain at least <br>one number,one letter and at least 8 or more characters</p>
						<div id="formbuttons">
							<br>
